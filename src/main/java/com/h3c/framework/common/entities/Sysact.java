...
/**
 * Sysact entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "sysact")
public class Sysact implements java.io.Serializable {
	...
	/** minimal constructor */
	public Sysact(String actid, String objectid, String roleid,
			String objecttype) {
		this.actid = actid;
	...
	/** full constructor */
	public Sysact(String actid, String objectid, String roleid, String sceneid,
			String objecttype, String dispatchauth, String hashcode) {
		this.actid = actid;
		this.objectid = objectid;
		this.roleid = roleid;
