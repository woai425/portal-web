...
public class Sysgroup implements java.io.Serializable {
	...
	/** full constructor */
	public Sysgroup(String groupid, String name, String description,
			String parentid, String org, String districtcode, String license,
			String principal, String shortname, String address, String tel,
			String linkman, String type, String chargedept, String otherinfo,
			String owner, String status, Date createdate, String hashcode,
			String rate) {
		this.groupid = groupid;
		this.name = name;
