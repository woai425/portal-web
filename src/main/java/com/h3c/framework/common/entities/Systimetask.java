...
/**
 * Systimetask entity. @author MyEclipse Persistence Tools
 */
@Entity
...
public class Systimetask implements java.io.Serializable {
	...
	/** minimal constructor */
	public Systimetask(String taskid, String jobname, String jobgroup,
			String description, String cron, String classname, String active,
			String isstart, Date createdate, String creator) {
		this.taskid = taskid;
	...
	public Systimetask(String taskid, String jobname, String jobgroup,
			String description, String cron, String classname, String active,
			String isstart, Date createdate, String creator,
			Date updatedate, String updator) {
		this.taskid = taskid;
		this.jobname = jobname;
		this.jobgroup = jobgroup;
		this.description = description;
