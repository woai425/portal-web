...
public class Sysuser implements java.io.Serializable {
	...
	/** full constructor */
	public Sysuser(String userid, String passwd, String loginname, String dept,
			String description, String iplist, String checkip, String useful,
			String isleader, String regionid, String username, String owner,
			String rate, String certification, String macaddr, String usertype,
			String otherinfo, Date createdate, String hashcode,
			String email, String phone, String address,
			Date pswinvalidtime, String acctlockflag) {
		this.userid = userid;
		this.passwd = passwd;
