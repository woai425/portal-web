 ...
 * 
 * @author 周兆巍
 * @version 创建时间：2014年12月3日 下午4:37:44
 */
@Component
public abstract class ServiceSupport {

	@Autowired
	public H3cSession session;
	 ...
	 * @throws H3cException
	 */
	private int getTotalCount(String sql, String sqlType, Map<String, Object> mp) throws H3cException {
		int totalCount = 0;
	...
	public AjaxJson pageSqlQueryNoTotalCount(String sql, HashMap<String, Object> mp, Integer start, Integer limit)
		...
		for (int i = 0; i < objLst.size(); i++) {
			...
			if (obj.length != colLst.size()) {
				throw new H3cException("原生SQL字段解析异常，请确认！");
			}
