...
public class CopyIgnoreProperty extends CopyEventBean{
     ...
     */
	public static  void copy(Object fromObj, Object toObj) throws H3cException {
	...
	public static  void copyHashMap(HashMap<?, ?> fromHashMap, Object toObj) throws H3cException{
		BeanInfo toBeanInfo = null;
	 ...
	 * @throws H3cException
	 */
	public  static  void copyObjToHashMap(Object fromObj,HashMap<String,Object> toHashMap) throws H3cException{
		BeanInfo fromBeanInfo = null;
		try {
     ...
     */
	public  static  void copyStringToObject(String fromObj,Object toObj) throws H3cException{
		BeanInfo toBeanInfo = null;
		try {
			toBeanInfo = Introspector.getBeanInfo(toObj.getClass(),Object.class);
			PropertyDescriptor[] toProperties = toBeanInfo.getPropertyDescriptors();
			...
			if(fromObj.indexOf(",")>-1){
				...
				throw new H3cException("没有可以拷贝的属性"); 
			}	
     ...
     */
	public static <typeName> List<typeName> copyObjectArray(Object[] fromObj, Class<typeName> toObj) throws H3cException{	
