 ...
 * 
 * @author 周兆巍
 * @version 创建时间：2014年11月30日 下午3:35:26
 */
@NotProguard
public class DateUtil {
	 ...
	 * @throws Exception
	 */
	public static Long strDateToNum(String strDate) throws H3cException {
		if (strDate == null) {
			return null;
		}
		String[] date = null;
	 ...
	 * @throws Exception
	 */
	public static Long strDateToNum1(String strDate) throws H3cException {
		if (strDate == null) {
			return null;
		}
		String[] date = null;
	...
	// * @throws Exception
	// */
	// public static Long sysDateToNum() throws H3cException
	// {
	...
	public static Date stringToDate(String str, String format)
		...
		try {
			...
			throw new H3cException("解析日期字符串时出错！");
		}
	}
	 ...
	 *             转换失败将抛出此异常
	 */
	public static Date compactStringToDate(String str) throws H3cException {
	 ...
	 *             如果转换不成功将抛出此异常
	 */
	public static String compactStringDateToNormal(String str)
			throws H3cException {
	 ...
	 * @return 日期间天数
	 */
	public static int getDaysBetween(Date date_str, Date date_end)
			throws H3cException {
		...
		if (d1.after(d2)) { // swap dates so that d1 is start and d2 is end
			throw new H3cException("起始日期小于终止日期!");
		}
	 ...
	 * @return 日期间天数
	 */
	public static Date addDays(Date date, int days) throws H3cException {
	 ...
	 * @return 日期间天数
	 */
	public static Date addDays(String str, String format, int days)
			throws H3cException {
		Calendar calendar = Calendar.getInstance();
	 ...
	 * @throws H3cException
	 */
	public static java.sql.Date getSqlDate(Date date) throws H3cException {
	 ...
	 * @throws H3cException
	 */
	public static Date parseDate(String strDate) throws H3cException {
		...
		try {
			...
			throw new H3cException("日期解析出错！", e);
		}
	}
	 ...
	 * @throws Exception
	 */
	public static Date parseDateTime(String strDate) throws H3cException {
		if (strDate == null || strDate.trim().equals("")) {
			return null;
		}
		SimpleDateFormat sdf = new SimpleDateFormat(DATETIME_FORMAT);
		try {
			...
			throw new H3cException("时间解析异常！", e);
		}
	}
	 ...
	 * @throws Exception
	 */
	public static Integer getYM(String strDate) throws H3cException {
		if (strDate == null) {
			return null;
		}
		SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT);
