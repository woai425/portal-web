 ...
 * 散列值生成和校验处理公共类
 * @author 周兆巍
 * @version 创建时间：2014年11月1日 下午4:19:23
 */
@NotProguard
public class HashCodeUtil {
	 ...
	 * @throws H3cException
	 */
	public static String getSysFunctionId(String parent,String location,String title) throws H3cException{
		//return SHA1.sha1(parent+location+title+new Date().getTime()+UUIDHexUtil.generate36bit()).substring(3, 35);
	 ...
	 * @throws H3cException
	 */
	public static String getAclResourceId(String functionid) throws H3cException{
	 ...
	 * @throws H3cException
	 */
	public static String getGroupId(String parentid,String name) throws H3cException{
		//return SHA1.sha1(parentid+name+new Date().getTime()+UUIDHexUtil.generate36bit()).substring(2, 34);
		return UUIDHexUtil.generate32bit();
	}
	 ...
	 * @throws H3cException
	 */
	public static String getUserId(String loginname,String username) throws H3cException{
		//return SHA1.sha1(loginname+username+new Date().getTime()+UUIDHexUtil.generate36bit()).substring(1, 33);
		return UUIDHexUtil.generate32bit();
	}
	 ...
	 * @throws H3cException
	 */
	public static String getUserGroupId() throws H3cException{
		return UUIDHexUtil.generate32bit();
	}
	 ...
	 * @throws H3cException
	 */
	public static String getRoleId(String rolename) throws H3cException{
		//return SHA1.sha1(new Date().getTime()+rolename+UUIDHexUtil.generate36bit()).substring(6, 38);
		return UUIDHexUtil.generate32bit();
	}
	 ...
	 * @throws H3cException
	 */
	public static String getSysAclId(String roleid) throws H3cException{
	 ...
	 * @throws H3cException 
	 */
	public static String getBeanHashCode(Object obj) throws H3cException{
		String rtn = "";
		try {
			...
			throw new H3cException("生成散列值时发生错误！",e);
		}
		return rtn;
	}
	 ...
	 * 
	 * @param obj 待校验散列值的对象
	 * @param cueHashCode 要进行校验对象的散列值
	 * @return true表示散列有效，否则无效
	 * @throws H3cException 
	 */
	public static boolean validateHashCode(Object obj,String cueHashCode) throws H3cException{
	 ...
	 */  
	/*
	private static void sort(PropertyDescriptor[] propDes){
		for(int i=propDes.length;i>1;i--){
			for(int j=0;j<(i-1);j++){
				PropertyDescriptor p = propDes[j];
				PropertyDescriptor pr = propDes[j+1];
				String name = p.getName();
				String name2 = pr.getName();
