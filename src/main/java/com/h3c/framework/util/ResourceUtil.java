 ...
 * 
 * @author 周兆巍
 * @version 创建时间：2014年11月30日 下午6:49:59
 */
@NotProguard
public class ResourceUtil {
	 ...
	 * @throws H3cException
	 */
	public static void loadModelScriptEngine(String url,String title,String id) throws H3cException {
		try{
		ScriptEngineManager sem=new ScriptEngineManager(); 
	    ScriptEngine engine=sem.getEngineByName("javascript"); 
	    
	    //加载一个文件
	    File f= new File("D:\\2015H3C\\h3c\\WebContent\\basejs\\Index.js"); 
        ...
        inv.invokeFunction("logout",args);   
			...
			throw new H3cException("调用js引擎失败：" + e.getMessage());
		}
