 ...
 * @creator z10926<br/>
 * @create-time 2014年11月29日 下午10:20:16
 * @revision $Id: *
 **********************************************************************
 */
@Controller
...
public class LoginController extends ControllerSupport<Object> {
	...
	public AjaxJson checkuser(Sysuser user, HttpServletRequest req) throws Exception {
		...
		// // license validate
		// if (LicenseUtil.verify() == false) {
		// j.setMsg("license 验证失败！");
		// j.setSuccess(false);
		// return j;
		// }
		// 判断登录人员是否为超级管理员
		...
		if ("BASE64".equals(GlobalNames.sysConfig.get("H3C_PASSWORD_ENCODE"))) {
	...
	public String login(HttpServletRequest request) throws H3cException {
	...
	public String dispatchPage() throws H3cException {
	...
	public AjaxJson checkIsLoginOrNot(HttpServletRequest request, @RequestParam("loginname") String loginname,
			@RequestParam("username") String username) throws H3cException {
	...
	@ResponseBody
	public Boolean checkSessnIsTmoutOrNot(HttpServletRequest request) throws H3cException {
	...
	@ResponseBody
	public Boolean checkValidTime(HttpServletRequest request) throws H3cException {
