package com.h3c.framework.web.security.restauth.client.factory;
 ...
 * *********************************************************************
 * 认证请求工厂类，实现自定义的认证 <br/>
 * H3cHttpComponentsClientHttpRequestFactory.java <br/>
 *
 * H3C所有，<br/>
 ...
 * @creator z10926 <br/>
 * @create-time 2016年11月14日 上午11:08:22
 * @revision $Id: *
 **********************************************************************
 */
public abstract class H3cHttpComponentsClientHttpRequestFactory extends
		HttpComponentsClientHttpRequestFactory {
	
	public H3cHttpComponentsClientHttpRequestFactory(HttpClient httpClient) {
		super(httpClient);
	}
