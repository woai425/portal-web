package com.h3c.framework.web.security.restauth.server.digest;
 ...
 * H3cDigestAuthenticationFilter.java
 *
 * H3C所有，
 * 受到法律的保护，任何公司或个人，未经授权不得擅自拷贝。
 * @copyright   Copyright: 2015-2020
 * @creator     z10926<br/>
 * @create-time 2016年5月11日 下午2:06:01
 * @revision    $Id:  *
 **********************************************************************
 */
public class H3cDigestAuthenticationFilter extends GenericFilterBean implements MessageSourceAware {
	private static final Log logger = LogFactory.getLog(H3cDigestAuthenticationFilter.class);
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
		...
		try {
			...
			if (!serverDigestMd5.equals(digestAuth.getResponse()) && cacheWasUsed) {
				...
				userCache.putUserInCache(user);
				//user.getPassword()
				serverDigestMd5 = digestAuth.calculateServerDigest(password,
						request.getMethod());
			}
