package com.h3c.framework.web.system.servlet;
...
//		graphics.setColor(getRandColor(100, 200)); // ---2
		...
		// 取随机产生的认证码(4位数字)
		final String resultCode = "1111";//exctractRandCode();
...
//			graphics.setFont(new Font("Arial Black", Font.ITALIC, 18));
            ...
            // 设置字符，字符间距，上边距
			graphics.drawString(String.valueOf(resultCode.charAt(i)), (13 * i) + 5, 16);
		}
...
//
//			default:
//				return RandCodeImageEnum.ALL_CHAR_LETTER.generateStr(randCodeLength);
//			}
//		}
//	}
